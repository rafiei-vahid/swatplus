      ...
      do iob = 1, sp_ob%objs
        ...
        call hydcs_add_to (obcs(iob)%hcsin_m(iin), obcs(iob)%hcsin_d(iin))
        !! monthly print
        ...
        call hydcs_add_to (obcs(iob)%hcsin_y(iin), obcs(iob)%hcsin_m(iin))
        !! yearly print
        ...
        call hydcs_add_to (obcs(iob)%hcsin_a(iin), obcs(iob)%hcsin_y(iin))
